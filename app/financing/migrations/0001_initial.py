    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='Carousel/%Y/%m/%d', verbose_name='Фото')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='financing.financing')),
            ],
            options={
                'verbose_name': 'Новость Translation',
                'db_table': 'financing_financing_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
